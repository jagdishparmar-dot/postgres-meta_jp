...
pg.types.setTypeParser(1115 as Parameters<typeof pg.types.setTypeParser>[0], parseArray) // _timestamp
pg.types.setTypeParser(1182 as Parameters<typeof pg.types.setTypeParser>[0], parseArray) // _date
pg.types.setTypeParser(1185 as Parameters<typeof pg.types.setTypeParser>[0], parseArray) // _timestamptz
pg.types.setTypeParser(600 as Parameters<typeof pg.types.setTypeParser>[0], (x) => x) // point
pg.types.setTypeParser(1017 as Parameters<typeof pg.types.setTypeParser>[0], (x) => x) // _point
